  ...
  return (
    <div id="app-header" className="w-full flex-col md:flex-row flex justify-between items-start md:items-center gap-3 py-2.5 pb-3 border-b border-[#141d2c] select-none shrink-0">
      ...
      <div className="flex flex-col gap-1 md:gap-1.5">
        <div id="song-title-group" className="flex flex-wrap items-center gap-3">
          <h1 className="text-xl md:text-2xl font-bold font-sans tracking-tight text-white mb-0">
            {activeSong.title}
          </h1>
